        ...
        <>
            <Card style={
                ...
                <Form className="login-form" {...layout}
                    ...
                    <Form.Item name="secondLastname" label="Apellido Materno"
                        rules={
                            [
                                {
                                    pattern: /^(([A-za-z]+[\s]{1}[A-za-z]+)|([A-Za-z]+))$/,
                    ...
                    <Form.Item name="repeatPassword" label="repite tu Password"
                        dependencies={
                            ["password"]
                        }
                        hasFeedback
                            ...
                            [
                                {
                                ...
                                }, ({getFieldValue}) => (
                                    {
                                        validator(rule, value) {
                                            ...
                                            return Promise.reject("Las conteseñas ingresadas no coinciden!");
                                        }
                                    }
                                ),
                            ]
                    ...
                    <Form.Item wrapperCol={
                        ...
                        rules={
                            [
                                {
                                    validator: (_, value) => value ? Promise.resolve() : Promise.reject("Debes aceptar las politicas de la comunidad")
                                }, {
                                    required: true
                                },
                            ]
                    ...
                    <Form.Item wrapperCol={
                        ...
                        o
                        <a href="http://localhost:3000/principal/signin">ingresa!</a>
                    </Form.Item>
                </Form>
            </Card>
        </>
